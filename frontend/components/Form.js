...
export function Form(props) {
  ...
  return (
    <form id="form" onSubmit={onSubmit} >
      ...
      <input value={form.newQuestion} onChange={onChange} maxLength={50}  id="newQuestion" name="newQuestion" placeholder="Enter question" />
      <input value={form.newTrueAnswer} onChange={onChange} maxLength={50}  id="newTrueAnswer" name="newTrueAnswer" placeholder="Enter true answer" />
      <input value={form.newFalseAnswer} onChange={onChange} maxLength={50}  id="newFalseAnswer" name="newFalseAnswer" placeholder="Enter false answer" />
